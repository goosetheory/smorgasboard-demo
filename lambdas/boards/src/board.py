class Board:
	...
	def to_dict(self):
		return {
			...
			'startDateTimestamp': self.start_date.timestamp() * 1000 if self.start_date else None, # ms since epoch
			'endDateTimestamp': self.end_date.timestamp() * 1000 if self.end_date else None
		}